        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="supplier_kode" id="supplier_kode" class="form-control" required readonly>
...
<script>
    $(document).ready(function() {
        // Generate kode supplier saat modal dibuka
        $('#myModal').on('shown.bs.modal', function() {
            generateKodeSupplier();
        });
        
        // Fungsi untuk mengambil kode supplier otomatis
        function generateKodeSupplier() {
            $.ajax({
                ...
                success: function(response) {
                    $('#supplier_kode').val(response.kode);
                },
                error: function(xhr, status, error) {
                    ...
                    Swal.fire({
                        ...
                        text: 'Gagal menghasilkan kode supplier otomatis'
                    });
                }
            });
        }
        ...
        $("#form-tambah").validate({
            rules: {
                ...
                supplier_nama: {required: true, minlength: 3, maxlength: 200},
