...
Route::group(['prefix' => 'supplier'], function() {
    ...
    Route::get('/generate_kode', [SupplierController::class, 'generateKode']);
...
Route::group(['prefix' => 'barang'], function() {
    ...
    Route::get('/{id}', [BarangController::class, 'show_ajax']);       //menampilkan detail user
...
// ======== Jobsheet 8 tugas 4 ======== 
Route::prefix('barang')-> middleware(['authorize:ADM'])->group(function(){
...
Route::get('/import', [BarangController::class, 'import'])
     ...
     ->name('barang.import_ajax')
     ->middleware(['auth','authorize:ADM,MNG']);
Route::get('/export', [BarangController::class, 'export_excel'])->name('barang.export');
});
...
// AJAX modal & update
Route::get('stok/edit-form/{id}', [StokController::class, 'editForm'])->name('stok.editForm');
...
Route::get('penjualan/{id}/edit_ajax', [PenjualanController::class, 'edit_ajax'])->name('penjualan.edit_ajax');
...
Route::get('penjualan/export', [PenjualanController::class, 'export_excel'])->name('penjualan.export');
...
Route::get('/dashboard', function () {
    return view('dashboard'); // Ganti dengan tampilan yang sesuai
})->name('dashboard'); // Jangan lupa beri nama route
